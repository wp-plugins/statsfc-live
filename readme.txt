...
Add live scores for Premier League, FA Cup or League Cup matches to your WordPress website. To request an API key sign up for free at [statsfc.com/developers](https://statsfc.com/developers).
...
4. Set the API key and any other options. If you don't have any API key, sign up for free at statsfc.com/developers
...
2. Add a sidebar named "StatsFC Live" from the 'Settings > Widgets on Pages' menu in WordPress
3. Place the widget anywhere in a page, using the following code:

		[widgets_on_pages id="StatsFC Live"]
